...
/// # 가상 머신
/// 컴파일된 파일 실행 및 외부에서 함수 및 변수를 호출 가능
...
/// 인터프리터 해석기에서 추상 구문 트리(AST)로 변환할 때 사용할 상수들
#[derive(Debug, PartialEq, Clone)]
pub enum Literal {
   None,                   // 0x01
   I64(i64),               // 0x02
...
/// 인터프리터 해석기에서 추상 구문 트리(AST)로 변환할 때 사용할 타입들
...
/// 인터프리터 해석기에서 추상 구문 트리(AST)로 변환할 때 사용할 연산들
#[derive(Debug, PartialEq, Clone)]
pub enum Infix {
    Plus        = 0x20,     // +
    Minus       = 0x21,     // -
...
/// 인터프리터 해석기에서 추상 구문 트리(AST)로 변환할 때 사용할 접두연산들
#[derive(Debug, PartialEq, Clone)]
pub enum Prefix {
    Minus       = 0x40,
    Not         = 0x41,
...
/// 인터프리터 해석기에서 추상 구문 트리(AST)로 변환할 때 사용할 상태들
#[derive(Debug, PartialEq, Clone)]
pub enum Statement {
...
/// 인터프리터 해석기에서 추상 구문 트리(AST)로 변환할 때 사용할 구문들
#[derive(Debug, PartialEq, Clone)]
pub enum Expression {
...
/// 인터프리터 해석기에서 추상 구문 트리(AST)로 변환할 때 사용할 연산 우선순위들
